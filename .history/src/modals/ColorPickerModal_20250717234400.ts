	...
	onOpen() {
		...
		this.scope.register([], 'ArrowUp', () => {
			...
			if (selectedColorIdx >= 0) {
				lis[selectedColorIdx] = lis[selectedColorIdx].classList.remove('selected');
				selectedColorIdx -= 1;
				lis[selectedColorIdx] = lis[selectedColorIdx].classList.add('selected');
			}
		...
		this.scope.register([], 'ArrowDown', () => {
			...
			if (selectedColorIdx < lis.length) {
				lis[selectedColorIdx] = lis[selectedColorIdx].removeClass('selected');
				selectedColorIdx += 1;
